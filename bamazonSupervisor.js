...
/************************************************/
// FUNCTIONS
//  Running this application will list a set of menu options: View Product Sales by Department, Create New Department
var sprMenu = function() {
	inquirer.prompt([
		...
		switch (user.action) {
			// If a supervisor selects View Product Sales by Department, calling the  
